            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @else
                        ...
                        <p class="text-muted">Talebiniz yönetim onayından sonra uygulanır.@module('mail-forwarding') Aktif {{ config('mail-forwarding.domain') }} yönlendirmeniz varsa, yeni adrese de güncellenir.@endmodule</p>
