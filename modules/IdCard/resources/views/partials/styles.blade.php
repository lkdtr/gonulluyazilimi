...
<style>
    ...
    .id-card-photo { width: 22cqw; aspect-ratio: 3 / 4; flex: none; border-radius: 1.8cqw; object-fit: cover; background: rgba(0, 0, 0, .06); display: flex; align-items: center; justify-content: center; border: .4cqw solid var(--card-accent); }
