            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('email-redirects') }}">
                        ...
                        <div class="row">
                            <label class="col-md-8 offset-md-4 mb-3" for="agreement"><input name="agreement" id="agreement" value="true" type="checkbox" required> &nbsp; <a href="javascript:openModal('/email-agreement')"> E-Posta kullanım sözleşmesi</a>koşullarını kabul ediyorum</label>
                        </div>
